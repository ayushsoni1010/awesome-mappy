  ...
  >
    ...
    >
      ...
      <button
        ...
        class="absolute top-1/2 w-28 h-full flex justify-center items-center transform -translate-y-1/2 hover:bg-gray-100 transition-colors focus:outline-none right-0"
        @click="query = ''"
      >
